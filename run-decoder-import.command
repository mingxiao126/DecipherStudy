...
echo "==========================================="
echo "DecipherStudy - Decoder Import (Clickable)"
echo "==========================================="
echo ""
...
echo ""
if [ -n "$FILE_PATH" ]; then
  ./scripts/import-decoder-from-clipboard.sh "$SUBJECT" "$NAME" --file "$FILE_PATH"
else
  ./scripts/import-decoder-from-clipboard.sh "$SUBJECT" "$NAME"
fi
